...
export class ProductFormComponent implements OnInit {
  ...
  categories: Category[]=[]; ///categories!=: Category[]; ünlemin anlamı şuan bir şey tanımlamadım ama bana kızma tanımlıycam
  ...
  add(): void {
    const request: Product = {
      ...
      categoryId:Number(this.productForm.value.categoryId),//İlgili category Idyı al ama numerik olarak yazdır
